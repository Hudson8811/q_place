    ...
    if (answer){
        ...
        if (currentQuestion == countQuestions){
            ...
            $.getJSON('results.json', function(data) {
                ...
                var resultTitle = results[mostAnsver-1].title;
                var resultItogo = results[mostAnsver-1].text;

                var dataTitle = results[mostAnsver-1].share[0].title;
                var dataDescription = results[mostAnsver-1].share[0].description;
                var dataUrl = results[mostAnsver-1].share[0].url;
                ...
                $html += '<div class="share test__share">\n' +
                    ...
                    '<div class="share__socials" data-url="'+dataUrl+'"  data-title="'+dataTitle+'"  data-description="'+dataDescription+'">\n' +
